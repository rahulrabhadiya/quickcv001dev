...
import com.googlel.liferay.NoSuchEmployeeException;
import com.googlel.liferay.model.Employee;
import com.googlel.liferay.model.impl.EmployeeImpl;
import com.googlel.liferay.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	@Override
	public Employee updateImpl(com.googlel.liferay.model.Employee employee)
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setEmpType(employee.getEmpType());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.googlel.liferay.model.Employee")));
